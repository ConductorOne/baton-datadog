...
*Schedules and application keys are not enabled by default. Enable **Sync schedules** or **Sync secrets** plus **Sync service account application keys**, respectively, when configuring the connector.
